...
// Axon-isms shared across the app
export const AXON_ISMS = [
...
export default function AxonAvatar({
  size = 140,
  mood = 'idle',
  showQuip = true,
  entrance = 'portal',
  ...
  const entranceVariants = entrance === 'portal' ? portalVariants : fadeVariants
  ...
  return (
    <div className={`flex flex-col items-center gap-3 ${className}`}>
      ...
      {/* Model with entrance animation + effects */}
      <motion.div
        className="relative axon-mascot"
        variants={entrance !== 'none' ? entranceVariants : undefined}
      ...
      >
        ...
        {/* 3D model — transparent, no background box */}
